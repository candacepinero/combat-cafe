    ...
    return (
        <Grid container spacing={2} >
            ...
            <Grid item xs={6} >
                ...
                <Typography variant="h2" align="center" fontFamily={"Black Ops One"} color={"#5f7f01"}>Combating Hunger</Typography>

                <Box border={"solid 2px #a2c17c"}>
                    <Typography variant="h3" align="center" fontFamily={"Black Ops One"}>About The Owners</Typography>
